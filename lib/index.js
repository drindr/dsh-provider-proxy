...
// dsh 0.1.2: the standalone installSettingsSection/settingsNamespace exports
// were removed from @deepseek-ai/dsh-settings; the canonical wiring is now the
// SettingsProvider service method ctx.settings.installSection, so the settings
// service is a hard dependency.
...
export function apply(ctx, config) {
  ...
  ctx.settings.installSection(ctx, NS, Config, base, {
    validate(value) {
